...
class ArticleRepositoryImpl implements ArticleRepository {
  ...
  Future<Article> fetchArticle(String url, {String? refererUrl}) async {
    ...
    final article = Article(
      ...
      seriesId: parsed.seriesName != null ? null : null, // seriesId will be resolved in insertOrUpdate via homeUrl
    );
  ...
  Future<void> updateTitleName(String titleId, String name) =>
      _local.updateSeriesName(titleId, name);

  @override
  Future<void> removeHistoryForTitle(String titleId) =>
      _local.removeHistoryForSeries(titleId);

  @override
  Future<void> removeBookmarksForTitle(String titleId) =>
      _local.removeBookmarksForSeries(titleId);
}
